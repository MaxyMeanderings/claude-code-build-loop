...
<div class="three"><section><h3>The brief · what it must do</h3><p>BUILD-BRIEF.md, one page. Every behavior rule, BR-01 to BR-25, and every exclusion, EX-01 to EX-08, traces back to a line in it.</p></section><section><h3>The Specify prompt · what good looks like</h3><p>coach/BUILD-STEPS.md § 2. Numbered, observable requirements. Acceptance cases with a <em>fails if</em> line. Traceability to files. And an engineering bar, one principle at a time, below.</p></section><section><h3>Its questions · what you decide</h3><p>Eight open questions with proposed defaults before a line was written: packaging, where it runs, the experiment gate, persistence. Answered in SPEC.md § 10. Reopening one is a spec change.</p></section></div><div class="bar"><div><b>DRY</b><span>applies · one authoritative home per rule</span><a class="src" href="https://pragprog.com/tips/" target="_blank" rel="noopener noreferrer">Pragmatic Programmer, tip 15 ↗</a></div><div><b>SOLID</b><span>per principle · SRP yes, Liskov N/A, no types</span><a class="src" href="https://blog.cleancoder.com/uncle-bob/2020/10/18/Solid-Relevance.html" target="_blank" rel="noopener noreferrer">Robert C. Martin, 2020 ↗</a></div><div><b>ACID</b><span>N/A · no database, a prompt cannot promise it</span><a class="src" href="https://www.ibm.com/docs/en/iis/11.7.0?topic=transactions-transaction-properties" target="_blank" rel="noopener noreferrer">IBM, transaction properties ↗</a></div><div><b>Big O</b><span>partial · bounded context and output, no class for reasoning</span><a class="src" href="https://www.cs.cmu.edu/~mgormley/courses/ml-primer/bigO.html" target="_blank" rel="noopener noreferrer">Carnegie Mellon, Big O primer ↗</a></div><div><b>Convention over configuration</b><span>applies · fixed file names and headings</span><a class="src" href="https://guides.rubyonrails.org/getting_started.html" target="_blank" rel="noopener noreferrer">Rails guides, getting started ↗</a></div></div><div class="takeaway">The brief is yours. So is the bar: swap DRY and SOLID for brand rules, compliance, accessibility. The builder asks about the rest.</div>

<div class="source">coach/BUILD-BRIEF.md · coach/BUILD-STEPS.md § 2 · coach/SPEC.md § 6 and § 10 · sources linked on each tile</div>
